...
\hline \\[-1.8ex] 
 OEO grants & 0.122$^{**}$ (0.056) & 0.118$^{**}$ (0.055) & 0.116$^{**}$ (0.056) & 0.116$^{*}$ (0.060) \\ 
  CBO & 0.163 (0.135) & 0.190 (0.135) & 0.221 (0.140) & 0.221$^{*}$ (0.129) \\ 
  Latino org & $-$0.262$^{**}$ (0.106) & $-$0.207$^{*}$ (0.109) & $-$0.231$^{**}$ (0.112) & $-$0.231$^{*}$ (0.124) \\ 
  Asian pop &  & 0.011$^{*}$ (0.007) & 0.011 (0.007) & 0.011 (0.013) \\ 
  Latino pop &  & 0.002 (0.005) & 0.008 (0.007) & 0.008 (0.007) \\ 
  Poverty rate &  &  & $-$0.006 (0.010) & $-$0.006 (0.010) \\ 
  Total population &  &  & $-$0.002 (0.002) & $-$0.002 (0.002) \\ 
