...
opt_breaks <- breakpoints(breakpoints(log(Freq) ~ Year + intervention + Year * intervention + category + Type, data = reagan_org), breaks = 2)
...
\cline{2-4} 
\\[-1.8ex] & \multicolumn{3}{c}{Founding rate (logged)} \\ 
\\[-1.8ex] & (1) & (2) & (3)\\ 
\hline \\[-1.8ex] 
 Year & 0.066$^{***}$ (0.016) & 0.066$^{***}$ (0.016) & 0.066$^{***}$ (0.016) \\ 
  intervention1 & 80.450$^{**}$ (33.919) & 80.450$^{**}$ (33.919) & 80.450$^{**}$ (33.919) \\ 
  TypeCBO & 1.096$^{***}$ (0.092) & 1.096$^{***}$ (0.092) & 1.096$^{***}$ (0.092) \\ 
  TypeHybrid & $-$0.054 (0.102) & $-$0.054 (0.102) & $-$0.054 (0.102) \\ 
  categoryLatino & 0.247$^{***}$ (0.077) & 0.247$^{***}$ (0.077) & 0.247$^{***}$ (0.077) \\ 
  Year:intervention1 & $-$0.041$^{**}$ (0.017) & $-$0.041$^{**}$ (0.017) & $-$0.041$^{**}$ (0.017) \\ 
  Constant & $-$130.508$^{***}$ (31.286) & $-$130.508$^{***}$ (31.286) & $-$130.508$^{***}$ (31.286) \\ 
 \hline \\[-1.8ex] 
Observations & 178 & 178 & 178 \\ 
R$^{2}$ & 0.594 & 0.594 & 0.594 \\ 
Adjusted R$^{2}$ & 0.580 & 0.580 & 0.580 \\ 
Akaike Inf. Crit. & 273.025 & 273.025 & 273.025 \\ 
\hline 
\hline \\[-1.8ex] 
...
lm_log.out2 <- lm(log(Freq) ~ Year + Year*intervention + Type + category, data = reagan_org_fit)

lm_log.out3 <- lm(log(Freq) ~ Year + Year*intervention + intervention + Type + category, data = reagan_org_fit)
