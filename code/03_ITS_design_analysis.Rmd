...
\hline \\[-1.8ex] 
 Year & 0.055$^{***}$ & 0.051$^{***}$ \\ 
  & (0.019) & (0.018) \\ 
  & & \\ 
 intervention1 & 72.412$^{*}$ & $-$1.265 \\ 
  & (39.509) & (73.659) \\ 
  & & \\ 
 TypeCBO & 0.598$^{***}$ & 0.601$^{***}$ \\ 
  & (0.101) & (0.140) \\ 
  & & \\ 
 categoryLatino & 0.381$^{***}$ & 0.222$^{*}$ \\ 
  & (0.093) & (0.125) \\ 
  & & \\ 
 Year:intervention1 & $-$0.037$^{*}$ & 0.0003 \\ 
  & (0.020) & (0.037) \\ 
  & & \\ 
 Constant & $-$108.077$^{***}$ & $-$100.482$^{***}$ \\ 
  & (37.778) & (35.149) \\ 
  & & \\ 
\hline \\[-1.8ex] 
Observations & 220 & 106 \\ 
R$^{2}$ & 0.253 & 0.235 \\ 
Akaike Inf. Crit. & 463.991 & 210.530 \\ 
\hline 
\hline \\[-1.8ex] 
...
- Full data
  - p-value for Intervention: 6.822022e-02
  - p-value for Intervention:Year: 1.137977e-08
  - degrees of freedom: 214
  
- Subsetted data 
  - p-value for Intervention: 0.7671248
  - p-value for the interaction between Intervention and Year: 0.2399375
...
lm_log.out <- lm(log(Freq) ~ Year + intervention + Year*intervention + Type + category, data = reagan_org_fit)

lm_log.out1 <- lm(log(Freq) ~ Year + intervention + Year*intervention + Type + category, data = reagan_org_fit)

lm_log.out2 <- lm(log(Freq) ~ Year + intervention + Year*intervention + Type + category, data = reagan_org)
