...
\hline \\[-1.8ex] 
 Year & 0.059$^{***}$ (0.016) & 0.066$^{***}$ (0.016) \\ 
  intervention1 & 65.817$^{*}$ (34.856) & 77.997$^{**}$ (34.326) \\ 
  TypeCBO & 1.056$^{***}$ (0.095) & 1.071$^{***}$ (0.093) \\ 
  TypeHybrid & $-$0.052 (0.107) & $-$0.047 (0.105) \\ 
  categoryLatino &  & 0.232$^{***}$ (0.079) \\ 
  Year:intervention1 & $-$0.033$^{*}$ (0.018) & $-$0.040$^{**}$ (0.017) \\ 
  Constant & $-$116.355$^{***}$ (31.676) & $-$129.500$^{***}$ (31.287) \\ 
 \hline \\[-1.8ex] 
Observations & 172 & 172 \\ 
R$^{2}$ & 0.562 & 0.584 \\ 
Adjusted R$^{2}$ & 0.549 & 0.569 \\ 
Akaike Inf. Crit. & 270.819 & 263.997 \\ 
\hline 
\hline \\[-1.8ex] 
...
\cline{2-4} 
\\[-1.8ex] & Founding rate (logged) &   & log(Freq) \\ 
\\[-1.8ex] & \textit{OLS} & \textit{coefficient} & \textit{MM-type} \\ 
 & \textit{} & \textit{test} & \textit{linear} \\ 
 & Model 1 & Model 2 & Model 3 \\ 
\hline \\[-1.8ex] 
 Federal funding & 0.325$^{***}$ (0.103) & 0.325$^{***}$ (0.086) & 0.325$^{***}$ (0.083) \\ 
  Population growth & 0.027 (0.174) & 0.027 (0.090) & 0.022 (0.106) \\ 
  Latino & 0.397 (0.596) & 0.397 (0.302) & 0.415 (0.419) \\ 
  Presidency & $-$0.178 (0.187) & $-$0.178 (0.240) & $-$0.180 (0.201) \\ 
  Senate &  &  &  \\ 
  House &  &  &  \\ 
  Constant & $-$0.507 (0.398) & $-$0.507 (0.445) & $-$0.493 (0.372) \\ 
 \hline \\[-1.8ex] 
Observations & 32 &  & 32 \\ 
R$^{2}$ & 0.498 &  & 0.472 \\ 
Adjusted R$^{2}$ & 0.423 &  & 0.394 \\ 
\hline 
\hline \\[-1.8ex] 
