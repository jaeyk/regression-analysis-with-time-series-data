...
ggsave(make_here("/home/jae/analyzing-asian-american-latino-civic-infrastructure/outputs/pred_subgroups.png"), height = 7, width = 11)

```
## Model evaluations

% Table created by stargazer v.5.2.2 by Marek Hlavac, Harvard University. E-mail: hlavac at fas.harvard.edu
% Date and time: Thu, Jul 23, 2020 - 02:13:38 PM
...
Observations & 78 & 78 \\ 
R$^{2}$ & 0.128 & 0.149 \\ 
Adjusted R$^{2}$ & 0.092 & 0.102 \\ 
Residual Std. Error & 0.691 (df = 74) & 0.687 (df = 73) \\ 
F Statistic & 3.608$^{**}$ (df = 3; 74) & 3.198$^{**}$ (df = 4; 73) \\ 
\hline 
\hline \\[-1.8ex] 
...
lm_log.out <- lm(log(Freq) ~ Year + intervention + Year*intervention, data = reagan_org_fit)

lm_log.out1 <- lm(log(Freq) ~ Year + intervention + Year*intervention, data = reagan_org_fit_cbo)
  
lm_log.out2 <- lm(log(Freq) ~ Year + intervention + Year*intervention + category, data = reagan_org_fit_cbo)
...
stargazer(lm_log.out1, lm_log.out2, 
...
OLS AIC:461.78
Logged OLS AIC:225.794
Poisson AIC:411.314
Negative binomial AIC:408.847
