...
logged.ols.model + facet_wrap(~Type)
...
ols_its_only_cbo(reagan_org %>% mutate(Freq = log(Freq))) + ggtitle("OLS with logged DV") + labs(y = "Organizational founding") + facet_wrap(~category)
