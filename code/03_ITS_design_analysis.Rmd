...
\hline \\[-1.8ex] 
 Year & 0.052$^{***}$ & 0.056$^{***}$ \\ 
  & (0.019) & (0.019) \\ 
  & & \\ 
 intervention1 & 20.726 & 23.597 \\ 
  & (79.585) & (79.468) \\ 
  & & \\ 
 categoryLatino &  & 0.159 \\ 
  &  & (0.135) \\ 
  & & \\ 
 Year:intervention1 & $-$0.011 & $-$0.012 \\ 
  & (0.040) & (0.040) \\ 
  & & \\ 
 Constant & $-$101.771$^{***}$ & $-$109.353$^{***}$ \\ 
  & (37.500) & (37.973) \\ 
  & & \\ 
\hline \\[-1.8ex] 
Observations & 106 & 106 \\ 
R$^{2}$ & 0.083 & 0.095 \\ 
Akaike Inf. Crit. & 225.794 & 226.337 \\ 
\hline 
\hline \\[-1.8ex] 
...
- Without group category variable 
  - p-value for Intervention: 0.7950635 
  - p-value for Intervention:Year: 0.7893909

- With group category variable 
  - p-value for Intervention: 0.7950635 
  - p-value for the interaction between Intervention and Year: 0.7893909

```{r}

lm.out <- lm(Freq ~ Year + intervention + Year*intervention + Type + category, data = reagan_org_fit)

lm_log.out <- lm(log(Freq) ~ Year + intervention + Year*intervention + category, data = reagan_org_fit)

lm_log.out2 <- lm(log(Freq) ~ Year + intervention + Year*intervention, data = reagan_org_fit)
...
add_AIC_pvalue(lm_log.out)$p.value[3:4]
