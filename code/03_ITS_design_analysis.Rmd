...
ggsave("/home/jae/analyzing-asian-american-latino-civic-infrastructure/outputs/dic_newspaper.png")
...
ols.model <- ols_its(reagan_org) + ggtitle("OLS") + labs(y = "Organizational founding") + ylim(c(-1,9))

logged.ols.model <- ols_its(reagan_org %>% mutate(Freq = log(Freq))) + ggtitle("OLS with logged DV") + labs(y = "Organizational founding (logged)") + ylim(c(-1, 4))

ols.model + logged.ols.model

ggsave("/home/jae/analyzing-asian-american-latino-civic-infrastructure/outputs/ols_plots.png", width = 10)
...
ggsave("/home/jae/analyzing-asian-american-latino-civic-infrastructure/outputs/non_ols_plots.png", width = 10)
