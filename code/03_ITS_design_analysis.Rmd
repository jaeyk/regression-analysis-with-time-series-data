...
ols.model <- ols_its(reagan_org) + ggtitle("OLS") + labs(y = "Organizational founding") + ylim(c(-1,9)) + xlim(c(1970,1990))

logged.ols.model <- ols_its(reagan_org %>% mutate(Freq = log(Freq))) + ggtitle("OLS + ln(DV)") + labs(y = "Organizational founding ") + ylim(c(-1, 3)) + xlim(c(1970,1990))
