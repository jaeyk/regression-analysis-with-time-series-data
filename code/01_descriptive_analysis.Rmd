...
pop_density_plot <- ggplot(org_count, aes(x = decade, y = ratio, 
    ...
    scale_fill_npg() +
    labs(x = "Decade", 
         y = "N of organizations founded (per 1 million population)", 
         title = "Organizational founding trend (density)")

ggarrange(pop_mass_plot, pop_density_plot, common.legend = TRUE, nrow = 2)

ggsave(here("outputs", "pop_mass_densty.png"),
       height = 9, width = 8)
