...
ggsave("/home/jae/analyzing-asian-american-latino-civic-infrastructure/outputs/asian_latino_orgs_n.png", height = 8)
...
merged %>%
  ...
  ggplot(aes(x = F.year, y = Freq)) +
    ...
    xlim(c(1964,2017)) +
    annotate("rect", xmin = 1964, xmax = 1980, ymin = 0, ymax = 20, alpha = .2) +
...
ggsave("/home/jae/analyzing-asian-american-latino-civic-infrastructure/outputs/org_founding_year_combined.png", height = 10, width = 8)
```
